...
# Detrás de Render (proxy), esto evita generar URLs http cuando el sitio está en https.
...
CSRF_TRUSTED_ORIGINS = [
    o.strip()
    for o in os.getenv("DJANGO_CSRF_TRUSTED_ORIGINS", "http://localhost:5174").split(",")
    if o.strip()
]
